...
EOF
     ...
     */
    protected function taskConfigure(): void
    {
        ...
        $this->doConfigure('show_full_name_in_reg_form', false);
        $this->doConfigure('show_team_managers', true);
        $this->doConfigure('show_team_manager_emails', true);
        $this->doConfigure('show_team_members_in_reg_form', true); // show the "Team members" field during registration
     ...
     */
    protected function doConfigure(string $name, mixed $value): void
    {
     ...
     */
    protected function taskCategories(): void
    {
     ...
     */
    protected function taskSites(): void
    {
     ...
     * Load affiliations.
     */
    protected function taskAffiliations(string $path): void
    {
     ...
     * Export affiliations.
     */
    protected function taskExportAffiliations(OutputInterface $output): void
    {
     ...
     */
    protected function taskLanguages(): void
    {
     ...
     */
    protected function disableRegistration(): void
    {
     ...
     */
    protected function isTaskEnabled(InputInterface $input, string $task): bool
    {
     ...
     */
    protected function isConfigurationSet(string $name): bool
    {
     ...
     */
    protected function setConfiguration(string $name, mixed $value): void
    {
